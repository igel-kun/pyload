...
class RapidshareCom(Hoster):
    ...
    def handleFree(self):
        ...
        self.log_debug("RS API Request: %s" % download)
    ...
    def handlePremium(self):
        ...
        self.log_debug("%s: Use Premium Account" % self.__name__)
    ...
    def download_api_data(self, force=False):
        ...
        self.log_debug("RS INFO API: %s" % src)
    ...
    def freeWait(self):
        ...
        self.log_debug("RS API Request: %s" % prepare)
        result = self.load(prepare, ref=False)
        self.log_debug("RS API Result: %s" % result)
